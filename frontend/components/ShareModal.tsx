...
export default function ShareModal({ isOpen, onClose, songTitle, songArtist }: ShareModalProps) {
    useEffect(() => {
        if (isOpen) {
    ...
    const shareText = songTitle && songArtist
        ? `Check out "${songTitle}" by ${songArtist} on MoodTune!`
        : 'Check out this amazing song on MoodTune!'
    ...
    return (
        <div className={styles.overlay} onClick={onClose}>
            <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
                ...
                <h2 className={styles.title}>Share Song</h2>
                ...
                <div className={styles.shareOptions}>
                    ...
                    >
                        <div className={styles.iconWrapper} style={{ backgroundColor: '#6B7280' }}>
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="white">
