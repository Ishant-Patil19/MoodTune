            ...
            <div className={styles.contentRectangle}>
                ...
                <div className={styles.content}>
                    <p className={styles.message}>
                        This page is under development. Here you'll be able to use your camera for emotion detection and get personalized music recommendations based on your mood.
                    </p>
                </div>
